...
INSERT INTO `customers` (`id`, `email`, `nick_name`, `password`, `created_at`, `updated_at`, `is_deleted`) VALUES
	...
	(7, 'huy2@gmail.com', 'huy', '$2y$10$7XlHQ4q3JX34za8TwJR5M.itquJxGvyPJ7Njoip0X6O7QUH0Z/xiu', '2019-01-08 10:03:14', '2019-01-08 10:03:14', 0);
...
CREATE TABLE IF NOT EXISTS `dooralarm` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mac_device` varchar(250) DEFAULT NULL,
...
-- Dumping structure for table api_vsecurity.dooralarm_customer
CREATE TABLE IF NOT EXISTS `dooralarm_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mac_device` varchar(250) DEFAULT NULL,
...
-- Dumping data for table api_vsecurity.dooralarm_customer: ~1 rows (approximately)
/*!40000 ALTER TABLE `dooralarm_customer` DISABLE KEYS */;
INSERT INTO `dooralarm_customer` (`id`, `mac_device`, `id_customer`, `is_owner`, `created_at`, `updated_at`) VALUES
	(1, 'huy', 6, NULL, '2019-01-09 09:06:43', '2019-01-09 09:06:43');
/*!40000 ALTER TABLE `dooralarm_customer` ENABLE KEYS */;
